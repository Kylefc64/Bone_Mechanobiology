...
%both(1,:,:,:) = squeeze(maskededge(1,:,:,:)) + squeeze(surface_masks(1,:,:,:)) .* imdilate(squeeze(BFsignal(1,:,:,:)), se);
%both(2,:,:,:) = squeeze(maskededge(2,:,:,:)) + squeeze(surface_masks(2,:,:,:)) .* imdilate(squeeze(BFsignal(2,:,:,:)), se);
