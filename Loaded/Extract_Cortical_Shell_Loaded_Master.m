function Extract_Cortical_Shell_Loaded_Master(spec_nums, num_slices)
...
for i = 1:num_specs
    ...
    innerMaskDir = ['\\Biomech-11\n\RTL06_R', spec_nums{i}, '_C8_Processed\Tiled\Masks\'];
    ...
    imageDir = ['\\Biomech-11\n\RTL06_R', spec_nums{i}, '_C8_Processed\Tiled\Gray\OP\'];
