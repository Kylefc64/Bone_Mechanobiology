function extractCorticalShell_RTL06_R55_C8()

%%%%%%%%%%% Enter inputs below %%%%%%%%%%

innerMaskDir = '\\Biomech-11\n\RTL06_R55_C8_Processed\Tiled\Masks\';
innerMaskName = 'RTL06_R55_C8_maks_';

outerMaskDir = '\\Biomech-11\n\RTL06_R55_C8_Processed\Tiled\CT_binary_registered\';
outerMaskName = 'CT_Binary_Registered_';

imageDir = '\\Biomech-11\n\RTL06_R55_C8_Processed\Tiled\Gray\OP\';
imageName = 'RTL06_R55_C8_gray';

targetDir = '\\Biomech-11\n\RTL06_R55_C8_Processed\Tiled\UV_Cortical_Shells\';
targetName = 'RTL06_R55_C8_UV_Cortical_Shell_';
